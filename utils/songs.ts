...
export const songs: Array<ISong> = [
  {
    name: "The One",
    author: "Kodaline",
    audio: "/music/The One - Kodaline.mp3",
  ...
  },
  {
    ...
    audio: "/music/Munn - Loved Us More.mp3",
